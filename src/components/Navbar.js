...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <marquee bgcolor="red" direction="left" color="white" style={{ color: "white", fontWeight: "bolder", margin: "0px" }}>
        Free Delievery on All items
      </marquee>

      <div className='container-fluid logobgcolor' >
        <div className='row py-3 '>
          ...
          <div className='col-4  pt-1' style={{ fontSize: "18px" }}>
            <img src='images/phone-icon1.png' width={40} height={40}></img>
          ...
          <div className='col-4 d-none d-lg-block pt-1' style={{ fontSize: "18px" }}>
            <img src='images/email-icon1.png' width={40} height={40}></img>
      ...
      <nav className= {` navbgcolor navbar navbar-expand-lg navbar-dark ${isNavOpen ? 'navbar-open' : ''}`} >
        <div className="container-fluid">
          ...
          >
            <span
              className={`navbar-toggler-icon ${isNavOpen ? 'd-none' : ''
                }`}
            />
            <span
